...
def validate_chunks_amount(id: str, chunks: List[Chunk]):
    ...
    known_high_amounts = {
        ...
        ('dword_ptr_c', ChunkOrigin.PHNT): 4,
        ('half_ptr_c', ChunkOrigin.PHNT): 4,
        ('int_ptr_c', ChunkOrigin.PHNT): 4,
        ('long_ptr_c', ChunkOrigin.PHNT): 4,
        ('mofresourceinfo', ChunkOrigin.PHNT): 4,
        ('phalf_ptr_c', ChunkOrigin.PHNT): 4,
        ('ptrdiff_t_c', ChunkOrigin.PHNT): 4,
        ('puhalf_ptr_c', ChunkOrigin.PHNT): 4,
        ('size_t_c', ChunkOrigin.PHNT): 4,
        ('size_t_max', ChunkOrigin.PHNT): 4,
        ('size_t', ChunkOrigin.PHNT): 4,
        ('ssize_t_c', ChunkOrigin.PHNT): 4,
        ('uhalf_ptr_c', ChunkOrigin.PHNT): 4,
        ('uint_ptr_c', ChunkOrigin.PHNT): 4,
        ('ulong_ptr_c', ChunkOrigin.PHNT): 4,
        # msdn.
